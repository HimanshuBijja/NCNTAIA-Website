...
import Abstract2 from "@/components/ui/abstractForm";
import AbstractForm from "@/components/ui/abstractForm";
                        ...
                        <CardContent className="space-y-6">
                            <div className="bg-slate-50 p-6 rounded-lg">
                                ...
                                <p className="text-slate-600 text-sm mb-4">
                                    Send your abstracts and full papers to the
                                    above email address with appropriate subject
                                    lines.
                                </p>
                            </div>
                    ...
                    <Card className="shadow-lg border-l-4 border-l-red-500">
                        ...
                        <CardContent className="space-y-4">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-600">
                                                Less than 10% plagiarism allowed
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                            ...
                            <p className="text-slate-600 text-sm">
                                <strong>Important:</strong> All submissions must
                                be original, unpublished, and plagiarism-free.
                                Authors are responsible for ensuring their work
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="bg-green-50 p-6 rounded-lg">
                                    ...
                                    <p className="text-slate-600 text-sm mb-4">
                                        All accepted papers will undergo a
                                        rigorous peer-review process by experts
                                        in the field.
                                    </p>
                                    <ul className="space-y-2 text-sm text-slate-600">
                                        ...
                                        <li className="flex items-start gap-2">
                                            <span className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></span>
                                            Expert reviewers from academia and
                                            industry
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></span>
                                ...
                                <div className="bg-blue-50 p-6 rounded-lg">
                                    ...
                                    <p className="text-slate-600 text-sm mb-4">
                                        ...
                                        publication in SCOPUS/WoS indexed
                                        journals.
                                    </p>
                                    <ul className="space-y-2 text-sm text-slate-600">
                                        <li className="flex items-start gap-2">
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div className="bg-blue-50 p-6 rounded-lg shadow-md flex flex-col h-full">
                                    <h4 className="font-bold text-blue-700 text-xl mb-2">
                                        Research Scholars / Students
                                    </h4>
                                ...
                                <div className="bg-purple-50 p-6 rounded-lg shadow-md flex flex-col h-full">
                                    <h4 className="font-bold text-purple-700 text-xl mb-2">
                                        Foreign Participants
                                    </h4>
